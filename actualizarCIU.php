...
<label for="id_ciu">ID DE LA CIUDAD</label>
<input type="TEXT" class="form-control mb-3" name="id_ciu" value="<?php echo $row['id_ciu']  ?>">

<label for="nom_ciu">NOMBRE DE LA CIUDAD</label>
    <input type="text" class="form-control mb-3" name="nom_ciu" value="<?php echo $row['nom_ciu']  ?>">
                    ...
                    <th><label for="busqueda"></label><br><a href="ciudad.php" class="btn btn-info">VOLVER</a></th>
